...
public class GUIGestione extends JFrame {
	...
	public GUIGestione(GestioneParcheggio g, ReaderWriterFromFile r) {
		...
		// JPanel principale che far� da contenitore per i due panel presenti sotto.
		...
		inserimento.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					LocalDate end = null; // In questo caso � ammissibile poich� ad end viene comunque assegnato un valore.
